...
export default function Home() {
  return (
    <>
      ...
      <div  className="absolute flex flex-col items-center text-center sm:top-[60%] left-1/2 -translate-x-1/2 -translate-y-1">
        <h1 className="font-bold text-5xl xs:text-6xl sm:text-7xl lg:text-8xl text-accent">DEVSOLARY</h1>
